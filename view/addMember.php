             ...
             <form action="index.php?action=addMember" method="post" name="sentMessage" id="contactForm" novalidate>
             <?php if(isset($erreur)){ echo $erreur;} ?>
                ...
                <div id="success"></div>
                    ...
                    <a href="index.php?action=admin"><button type="submit" name="creerCompte" class="btn btn-primary">Créer un compte</button></a>
                </div>
            </form>
