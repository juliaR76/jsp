...
if(!empty($_SESSION))
{
  $log = '          <div class="mx-auto text-center">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                                <li><a href="index.php?action=admin" class="nav-link">Bienvenue'.' '.$_SESSION['pseudo'].'</a></li>
...
}else
{
  $log = '          <div class="mx-auto text-center">
                        <nav class="site-navigation position-relative text-right" role="navigation">
                            <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block  m-0 p-0">
                                <li><a href="index.php?action=home" class="nav-link">Accueil</a></li>
                                <li><a href="index.php?action=home" class="nav-link">Infos</a></li>
                                <li><a href="index.php?action=home" class="nav-link">Inscription</a></li>
                            </ul>
                        </nav>
                        <button class="d-inline-block d-lg-none site-menu-toggle js-menu-toggle text-black float-right" tupe="button" data-target="#navbarResponsive"><span class="icon-menu h3"></span></button>
                    </div>';
...
<head>
    ...
    <link rel="stylesheet" href="public/css/stylePage.css">
